<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article-list.aspx.cs" Inherits="ZhiAiWang.UI.admin.article_list" %>
...
<body>
    ...
    <%--<div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> --%>
            <a class="btn btn-primary radius" data-title="添加活动" data-href="article-add.aspx" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加活动</a> <span class="r">共有数据：<strong><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></strong> 条</span> </div>
        <div class="mt-20">
            ...
            <ItemTemplate>
                ...
                <tbody>
                    <tr class="text-c">
                        ...
                        <td class="aa"><%#Eval("activitiesID") %></td>
                        ...
                        <td class="td-status"><span class="label label-success radius"><%#Eval("inCount") %></span></td>
                        <td><%#Eval("Moneys") %></td>
                        <td class="f-14 td-manage">
                         <%-- <i class="Hui-iconfont">&#xe6de;</i>--%> </a>
                            <a style="text-decoration:none" class="ml-5" onclick="article_del(this,'<%#Eval("activitiesID") %>')" href="javascript:;" title="删除">
                            <i class="Hui-iconfont">&#xe6e2;</i></a> 
                            <a href="article-update.aspx?id=<%#Eval("activitiesID") %>"><i class="Hui-iconfont">&#xe6df;</i></a>
