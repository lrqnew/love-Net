...
var IMG_LENGTH = 3;//图片最大1MB
var IMG_MAXCOUNT = 5;//最多选中图片张数
var IMG_AJAXPATH = "SetPhoto.ashx";//异步传输服务端位置
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data != -1) {
                    ...
                    $(".lookimg").eq(data).attr("ISUP", "1");//记录此图片已经上传
                    
                    $(".lookimg").eq(data).children(".lookimg_progress").eq(0).children("div").eq(0).animate({ width: "100%" }, UPTIME, function () {
