...
$(function(){
	...
	var tophtml="<div id=\"izl_rmenu\" class=\"izl-rmenu\"><a id='feedback' href=\"javascript:;\" class=\"btn btn-qq\"></a><div class=\"btn btn-wx\"><img class=\"pic\" src=\"/../public/home/images/hnweixin.jpg\" onclick=\"window.location.href=\'#\'\"/></div><div class=\"btn btn-phone\"><div class=\"phone\">sc.chinaz.com</div></div><div class=\"btn btn-top\"></div></div>";
	$("#top").html(tophtml);
...
function Focus() {
	...
	function changePic() {
		...
		} else if (iActive >= oPicLis.length - 1) {
			doMove(bytag('ul', oBtn)[0], 'left', -(oPicLis.length - 2) * (oBtnLis[0].offsetWidth + 3));
		} else {
	...
	aTimer = setInterval(autoplay, 12000);
	inlize();
